...
* **Enhanced Training Dataset (USAI10K):** เพิ่มและขยายขอบเขตการฝึกฝนโมเดลด้วยชุดข้อมูลภาพอัลตราซาวด์ทางการแพทย์ **USAI10K** รวมทั้งสิ้นกว่า **25,565 รูป** (แบ่งเป็นเซ็ต Train 20,452 รูป, Validation 2,556 รูป และ Test 2,557 รูป) เพื่อเพิ่มความหลากหลายและยกระดับความแม่นยำในการตรวจจับโรค
* **Single-Task Focus:** เจาะจงทำนายโรคและสิ่งผิดปกติทางการแพทย์ครอบคลุมคลาสหลักทั้งหมด 15 คลาส (15 Classes) ผ่านชั้น `prediction_layer` เพียงหนึ่งเดียว
* **Multi-GPU Logic Control:** ล็อกระบบให้เจาะจงใช้งานเฉพาะการ์ดจอหลักตัวแรก (`GPU:0`) เท่านั้น ป้องกันปัญหา Memory ชนกันบนเครื่องเซิร์ฟเวอร์แบบหลายการ์ดจอ
* **Custom Data Pipeline:** ดึงและประมวลผลรูปภาพแบบ On-the-fly จากพาธตาราง Master CSV ตรงเข้าสู่โมเดลด้วย OpenCV ช่วยควบคุมหน่วยความจำและทำ Data Augmentation ได้อย่างคล่องตัว
* **Strict Data Splitting:** แบ่งชุดข้อมูลฝึกฝนและทดสอบอย่างเด็ดขาดโดยอ้างอิงคอลัมน์ `split_data` จากไฟล์ตารางชุดข้อมูลโดยตรง เพื่อป้องกันปัญหาข้อมูลรั่วไหล (Data Leakage)
* **Monkey Patching for FixedDropout:** แก้ปัญหา `ValueError: Unknown layer: FixedDropout` จากโครงสร้าง Keras รุ่นเก่าขณะโหลดผ่าน JSON ได้อย่างสมบูรณ์แบบบน TensorFlow 2.10.1
